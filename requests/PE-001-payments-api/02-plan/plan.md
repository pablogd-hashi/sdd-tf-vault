...
Values copied verbatim from approved spec:
...
| Wrong SA binding | Values from spec: namespace `payments`, SA `payments-api` |

## Rollback

```bash
cd requests/PE-001-payments-api/03-terraform
terraform destroy
```
...
|------|------|----------|------|
| Platform engineer | platform-engineer | ☑ | 2026-07-28 |

**Plan approved. Proceed to Terraform implementation.**
